            ...
            <div className="playground">
                ...
                <main className="playground__content">
                    ...
                    <section className="playground__section">
                        ...
                        <div
                            className="showcase-group highlight"
                            style={{ padding: 'var(--spacing-16)', marginBottom: 'var(--spacing-16)', backgroundColor: '#3b3b3b' }}
                        >
                            <h3>Toggle with highlight</h3>
                            <div className="component-group" style={{ padding: 'var(--spacing-16)' }}>
                                <CollapsibleSection
                                    title="Details"
                                    isCollapsed={isCollapsed8}
                                    onToggle={setIsCollapsed8}
                        ...
                        >
                            ...
                            <div className="component-group" style={{ padding: 'var(--spacing-16)' }}>
                                <CollapsibleSection
                                    title="Details"
                                    isCollapsed={isCollapsed9}
                                    onToggle={setIsCollapsed9}
                                    rightDetails="7 props"
                                    toggleHighlight
                                    toggleAccent
                                >
                        ...
                        >
                            ...
                            <div className="component-group" style={{ padding: 'var(--spacing-16)' }}>
                                <CollapsibleSection
                                    title="Details"
                                    isCollapsed={isCollapsed10}
                                    onToggle={setIsCollapsed10}
                                    rightDetails="7 props"
                                    toggleHighlight
