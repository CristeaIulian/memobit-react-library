...
const iconAliases: Record<string, string[]> = {
    ...
    ninja: ['stealth', 'warrior', 'shinobi', 'martial-arts', 'shadow'],
    ...
    confetti: ['celebration', 'party', 'festive', 'fun', 'sprinkle', 'colorful'],
    ...
    angular: ['framework', 'typescript', 'google', 'spa', 'frontend', 'javascript'],
    ...
    cigarette: ['smoke', 'tobacco', 'nicotine', 'addiction', 'health', 'habit'],
    ...
    'ink-cartridge': ['printer', 'toner', 'ink', 'office', 'print', 'refill'],
    jupiter: ['planet', 'solar-system', 'space', 'gas-giant', 'astronomy', 'orbit'],
    'lock-open': ['unlocked', 'access', 'open', 'security', 'password', 'unlock'],
    mars: ['planet', 'red-planet', 'solar-system', 'space', 'astronomy', 'orbit'],
    mercury: ['planet', 'solar-system', 'space', 'astronomy', 'orbit', 'smallest'],
    money: ['cash', 'currency', 'dollar', 'finance', 'wealth', 'payment'],
    neptune: ['planet', 'solar-system', 'space', 'blue', 'astronomy', 'orbit'],
    pluto: ['dwarf-planet', 'solar-system', 'space', 'astronomy', 'orbit', 'kuiper'],
    shield: ['protection', 'security', 'defense', 'guard', 'safe', 'verified'],
    ...
    uranus: ['planet', 'solar-system', 'space', 'astronomy', 'orbit', 'ice-giant'],
    venus: ['planet', 'solar-system', 'space', 'astronomy', 'orbit', 'hot'],
};
