...
export const CalendarPage: React.FC = () => {
    ...
    return (
        <div className="component-page">
            <h1>Calendar</h1>
            <p>
                A flexible calendar component that supports single date, range, and multiple date
                selection modes with extensive customization options.
            </p>
            ...
            <section className="page-section">
                ...
                <div className="showcase-group">
                    <h3>Min/Max Dates</h3>
                    <p>
                        Restricted to current month and next month (
                ...
                <div className="showcase-group">
                    ...
                    <p>
                        Dates 15th and 20th of current month are disabled
                    </p>
                    <div className="component-group">
                        <Calendar
                            value={singleDate}
