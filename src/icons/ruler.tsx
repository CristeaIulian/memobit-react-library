    ...
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path
                ...
                strokeLinecap="round"
            ></path>{' '}
            <path d="M12 2L12 4M18 2L18 4M9 2L9 5M15 2L15 5" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M2 12H4M2 18H4M2 15L5 15M2 9L5 9" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
        </g>
    </svg>
);
