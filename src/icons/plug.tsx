    ...
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path
                ...
                strokeWidth="1.5"
            ></path>{' '}
            <path d="M13.5 11V9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M10.5 11V9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
        </g>
    </svg>
);
