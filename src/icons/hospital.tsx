export const hospital = (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path d="M10 12H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M5.5 11H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M5.5 14H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M17 11H18.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M17 14H18.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M5.5 8H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            <path d="M17 8H18.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
            ...
            <path
                ...
                fill="currentColor"
            ></path>{' '}
            <path d="M10 15H10.5M14 15H12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>{' '}
        </g>
    </svg>
);
