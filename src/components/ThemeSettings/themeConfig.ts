...
export const THEME_CONFIGS: ThemeConfig[] = [
    ...
    },
    {
        ...
        recommendedApps: ['Resume / CV', 'CookBook'],
    },
    {
    ...
    },
    {
        ...
        recommendedApps: ['Shelf', 'Ascend', 'Basket', 'CookBook', 'HUB'],
    ...
    },
    {
        ...
        recommendedApps: ['Garage', 'CookBook'],
    },
    {
        value: 'cobalt-pulse',
        label: 'Cobalt Pulse',
    ...
    },
    {
        value: 'signal-burst',
        label: 'Signal Burst',
        recommendedApps: ['Impulse', 'Garage', 'Ascend', 'Basket', 'CookBook'],
        fontUrl: 'https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600;700&display=swap',
    ...
    },
    {
        ...
        recommendedApps: ['NutriTrack', 'Garage'],
    },
    {
        value: 'citrus-vital',
        label: 'Citrus Vital',
    ...
    },
    {
        value: 'horizon-amber',
        label: 'Horizon Amber',
        recommendedApps: ['Ascend', 'Garage', 'Basket', 'HUB'],
        fontUrl: 'https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&display=swap',
    ...
    },
    {
        value: 'chalk-circuit',
        label: 'Chalk & Circuit',
        recommendedApps: ['Quiz Lab', 'Garage', 'Basket'],
        fontUrl: 'https://fonts.googleapis.com/css2?family=Nunito:wght@300;400;600;700;800&display=swap',
        fontUrlDisplay: 'https://fonts.googleapis.com/css2?family=Exo+2:wght@300;400;500;600;700&display=swap',
    },
    {
    ...
    },
    {
        ...
        recommendedApps: ['Voyage', 'Basket', 'CookBook', 'HUB'],
    ...
    },
    {
        value: 'crawler-dusk',
        label: 'Crawler Dusk',
        recommendedApps: ['Books Crawler', 'Ascend'],
    ...
    },
    {
        value: 'vital-signal',
        label: 'Vital Signal',
        recommendedApps: ['Health-IQ', 'Basket', 'HUB'],
        fontUrl: 'https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@300;400;500;600;700&display=swap',
        fontUrlDisplay: 'https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&display=swap',
    },
    {
    ...
    },
    {
        value: 'audit-ember',
        label: 'Audit Ember',
        recommendedApps: ['Network Audit', 'Garage'],
    ...
    },
    {
        value: 'chrono-atlas',
        label: 'Chrono Atlas',
        recommendedApps: ['Atlas of Time', 'Garage', 'Ascend', 'Basket', 'CookBook'],
